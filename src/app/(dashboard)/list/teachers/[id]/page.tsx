      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white rounded-md p-4 ">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            <Link className="p-3 cursor-pointer rounded-md bg-abiSky text-gray-500" href={"/"}>Teeacher&rsquo; Classes</Link>
            <Link className="p-3 cursor-pointer rounded-md bg-abiYellow text-gray-500" href={"/"}>Teeacher&rsquo; Students</Link>

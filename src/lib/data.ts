...
const today = new Date(2025, 2, 21); // February 25, 2025
...
export const calendarEvents = [
  ...
  },
  {
    ...
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 2, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 2, 14, 0),
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 2, 14, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 3, 9, 0),
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 3, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 3, 10, 0),
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 3, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 3, 11, 0),
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 3, 11, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 3, 14, 0),
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 3, 14, 45),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 4, 8, 0),
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 4, 8, 45),
  },
  {
    title: "English",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 4, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 4, 13, 0),
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 4, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 4, 14, 0),
    end: new Date(today.getFullYear(), today.getMonth(), today.getDate() + 4, 14, 45),
  },
];
